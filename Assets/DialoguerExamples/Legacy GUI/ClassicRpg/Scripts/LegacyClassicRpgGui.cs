...
public class LegacyClassicRpgGui : MonoBehaviour
{
	...
	void OnGUI()
	{
		...
		Rect dialogueBoxRect = centerRect(new Rect(rectX, rectY+25, rectWidth * _windowTweenValue, rectHeight-50 * _windowTweenValue));
